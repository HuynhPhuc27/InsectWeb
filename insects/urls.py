...
urlpatterns = [
    ...
    path('classification_history/', views.classification_history, name='classification_history'),
    path('delete_temp_images/', views.delete_temp_images, name='delete_temp_images'),
    path('data_classification/', views.image_classification, name='data_classification'),
    path('edit_caption/<int:img_id>/', views.edit_caption, name='edit_caption'),
    path('vote/<int:img_id>/', views.vote_image, name='vote_image'),
    path('dataset_statistics/', views.dataset_statistics, name='dataset_statistics'),
