# InsectWeb
Multimodal insect classification system use  Cross-Attention mechanism to integrate image features (ViT) and text descriptions (BERT). Integrated with a Django web interface for real-time identification..
